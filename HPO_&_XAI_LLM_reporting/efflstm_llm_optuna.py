...
SPEC_DIR = os.environ.get("SPEC_DIR", "./data/segment_spectrograms_21ch_stft_fixed")
OUT_ROOT = os.environ.get("OUT_ROOT", "./models_optuna_eff_gemini_verbose")
...
# ---------------- LLM Retry & Seeding Config ----------------
# You can tune these via environment variables:
#   LLM_SEED_CALLS      – how many LLM-generated hyperparameter seeds to enqueue (0–3 typical)
#   MAX_LLM_RETRIES     – max retries per Gemini call before failing (6 default)
#   INITIAL_BACKOFF_SEC – initial backoff for retry (seconds)
#   BACKOFF_MULTIPLIER  – exponential backoff multiplier
#   BACKOFF_CAP_SEC     – maximum sleep between retries
...
def _get_gemini_key() -> str:
    ...
    if not key:
        raise RuntimeError("Gemini key not configured. Set GEMINI_API_KEY in your environment.")
    return key
...
"""
    ...
    # Phase 1
    total_trials = int(os.environ.get("N_TRIALS","5"))
